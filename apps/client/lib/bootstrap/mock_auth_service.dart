...
/// In-memory [AuthService] for development/tests, so the auth screens are fully
/// exercisable without a backend (SPEC §8 heads-up).
///
/// The fixed code is [validCode]. `requestOtp` always "sends"; `verifyOtp`
/// accepts only [validCode]. Active when `--dart-define=MOCK_AUTH=true` or when
